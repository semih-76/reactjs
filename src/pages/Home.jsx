...
const Home = () => {
    return (
        <div className="home-container">
            ...
            <section className="products" aria-label="Produits phares">
            ...
            <section className="engagements" aria-label="Nos engagements">
            ...
            <section className="home-cta" aria-label="Rejoindre CafThé">
