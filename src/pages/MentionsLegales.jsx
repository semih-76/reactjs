...
const sections = [
  {
    ...
    table: [
      ...
      {
        label: "Siège social",
        value: "12 rue des Jardins, 75004 Paris, France",
      },
  ...
  },
  {
    ...
    table: null,
    content:
      "Ce site utilise des cookies strictement nécessaires à son bon fonctionnement. Ces cookies ne collectent aucune donnée personnelle identifiable. Vous pouvez à tout moment les désactiver dans les paramètres de votre navigateur, ce qui peut toutefois affecter certaines fonctionnalités du site.",
  },
  {
    id: "responsabilite",
    number: "06",
      ...
      <section className="legal-hero">
        <div className="legal-hero-inner">
          ...
          <p className="legal-subtitle">
            Informations légales relatives à l'éditeur et à l'utilisation du
            site cafthe.fr
          </p>
      ...
      <main className="legal-main">
        ...
        <div className="legal-crosslink">
          <div className="legal-crosslink-content">
            ...
            <h3 className="legal-crosslink-title">
              Conditions Générales de Vente
            </h3>
            <p className="legal-crosslink-text">
              Consultez nos CGV pour tout ce qui concerne vos achats, livraisons
              et retours.
            </p>
